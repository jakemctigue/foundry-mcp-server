...
| MCP surface             | 27 tools, five enumerable `foundry://` resources, and five bounded read-only prompts for campaign, recap, encounter, NPC, and change-review workflows.                                                                                    | Prompt text grants no mutation authority. See the generated-surface reference for exact schemas.                                |
